    ...
    <div id="vehicles-view" className="tab-content active">
      ...
      <div className="list-header-controls">
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          {(user?.role === 'ADMIN' || user?.role === 'CRM' || user?.role === 'BOOKING IN-CHARGE' || user?.role === 'FINANCE' || user?.role === 'TMA' || user?.role === 'ACCOUNTS' || user?.role === 'INSURANCE' || user?.role === 'REGISTRATION') && (
