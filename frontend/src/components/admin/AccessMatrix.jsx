...
const CRM_GROUPS = [
  ...
  { section: 'CRM TMA',          title: 'CRM TMA Details',          fields: [] },
  { section: 'CRM TALLY FILE',   title: 'CRM Tally File Details',    fields: [] },
  { section: 'CRM ACCOUNTS',     title: 'CRM Accounts Details',      fields: [] },
  { section: 'CRM INSURANCE',    title: 'CRM Insurance Details',     fields: [] },
  { section: 'CRM REGISTRATION', title: 'CRM Registration Details',  fields: [] },
  { section: 'CRM TMGA',         title: 'CRM TMGA Details',          fields: [] },
  { section: 'CRM PDI',          title: 'CRM PDI Details',           fields: [] },
  { section: 'CRM DELIVERY',     title: 'CRM Delivery Details',      fields: [] },
];
